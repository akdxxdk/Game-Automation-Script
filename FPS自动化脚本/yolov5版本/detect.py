...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='cfbest.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='cftest.mp4', help='file/dir/URL/glob, 0 for webcam')
